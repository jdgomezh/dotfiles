...
ln -sf "${ENV_ROOT}/Conf/Core/editor/NeoVim/loader/init.lua" "${XDG_CONFIG_HOME}/nvim/init.lua"
if [ ! -e "${XDG_CONFIG_HOME}/nvim/lua/plugin" ]; then
	ln -sf "${ENV_ROOT}/Conf/Core/editor/NeoVim/plugin" "${XDG_CONFIG_HOME}/nvim/lua/plugin"
fi
